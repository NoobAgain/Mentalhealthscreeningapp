...
export function ResultsStep({ score }: ResultsStepProps) {
  const getResult = () => {
    if (score <= 5) {
      return {
        ...
        color: 'green',
        icon: CheckCircle,
        message: 'Hasil skrining menunjukkan tingkat risiko rendah.',
        recommendation:
      ...
      return {
        ...
        color: 'yellow',
        icon: Info,
        message: 'Hasil skrining menunjukkan tingkat risiko sedang.',
        recommendation:
      ...
      return {
        ...
        color: 'red',
        icon: AlertCircle,
        message: 'Hasil skrining menunjukkan tingkat risiko tinggi.',
        recommendation:
  ...
  return (
    <div>
      <h2 className="text-indigo-900 mb-2">Langkah 4: Hasil Skrining</h2>
      ...
      >
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-700 text-sm">Skor: {score}/16</p>
          </div>
        </div>
      ...
      <div className="bg-blue-50 border-2 border-blue-200 p-6 rounded-lg">
        <h4 className="text-blue-900 mb-2">Informasi Penting</h4>
        <ul className="text-gray-700 text-sm space-y-2 list-disc list-inside">
          <li>Hasil skrining ini bersifat indikatif dan bukan diagnosis medis</li>
          <li>Konsultasi dengan profesional kesehatan tetap diperlukan untuk diagnosis akurat</li>
          <li>Layanan kesehatan mental JKN tersedia di fasilitas kesehatan terdekat</li>
